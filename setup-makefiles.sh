...
LINEEND=" \\"
COUNT=`wc -l ../../oppo/msm8974-caf-common/proprietary-files.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../../oppo/msm8974-caf-common/proprietary-files.txt`
COUNT=`expr $COUNT - $DISM`
for FILE in `egrep -v '(^#|^$)' ../../oppo/msm8974-caf-common/proprietary-files.txt`; do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
...
export DEVICE=msm8974-caf-common
export VENDOR=oppo
OUTDIR=vendor/$VENDOR/$DEVICE
MAKEFILE=../../../$OUTDIR/$DEVICE-vendor-blobs.mk
...
LINEEND=" \\"
COUNT=`wc -l ../../oppo/msm8974-caf-common/proprietary-files-qc.txt | awk {'print $1'}`
DISM=`egrep -c '(^#|^$)' ../../oppo/msm8974-caf-common/proprietary-files-qc.txt`
COUNT=`expr $COUNT - $DISM`
for FILE in `egrep -v '(^#|^$)' ../../oppo/msm8974-caf-common/proprietary-files-qc.txt`; do
  COUNT=`expr $COUNT - 1`
  if [ $COUNT = "0" ]; then
    LINEEND=""
  fi
